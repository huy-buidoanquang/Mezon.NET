...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        public Task<bool> AuthenticateAppLogoutAsync(AppAuthenticationLogoutRequest body, RequestOptions? options = null)
        {
            throw new NotImplementedException();
        }
        ...
        //public async Task UpdateMezonVoiceStateAsync(HandleParticipantMeetStateEvent body, RequestOptions? options = null)
        //{
        //    Check.NotNull(body, nameof(body));
        //    GRPCClient.SetHeader("Authorization", GetPrefixedToken(TokenType, AuthToken));
        //    options = RequestOptions.CreateOrClone(options);
