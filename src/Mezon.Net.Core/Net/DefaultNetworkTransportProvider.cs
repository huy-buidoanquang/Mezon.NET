...
namespace Mezon.Net.Core
{
    public static class DefaultNetworkTransportProvider
    {
        ...
        private static readonly ConcurrentDictionary<TransportType, MezonNetworkTransportProvider> _registry = new ConcurrentDictionary<TransportType, MezonNetworkTransportProvider>();
