...
namespace Mezon.NET.WebSocket
{
    public partial class BaseSocketClient
    {
        ...
        public event Func<Protobuf.Realtime.Status, Task> StatusEvent
        {
            add { _statusEvent.Add(value); }
            remove { _statusEvent.Remove(value); }
        }
        internal readonly AsyncEvent<Func<Protobuf.Realtime.Status, Task>> _statusEvent = new AsyncEvent<Func<Protobuf.Realtime.Status, Task>>();

        public event Func<Protobuf.Realtime.StatusFollow, Task> StatusFollowEvent
        {
            add { _statusFollowEvent.Add(value); }
            remove { _statusFollowEvent.Remove(value); }
        }
        internal readonly AsyncEvent<Func<Protobuf.Realtime.StatusFollow, Task>> _statusFollowEvent = new AsyncEvent<Func<Protobuf.Realtime.StatusFollow, Task>>();

        public event Func<Protobuf.Realtime.StatusPresenceEvent, Task> StatusPresenceEvent
        {
            add { _statusPresenceEvent.Add(value); }
            remove { _statusPresenceEvent.Remove(value); }
        }
        internal readonly AsyncEvent<Func<Protobuf.Realtime.StatusPresenceEvent, Task>> _statusPresenceEvent = new AsyncEvent<Func<Protobuf.Realtime.StatusPresenceEvent, Task>>();
